...
function App() {
  ...
  return (
    ...
    <Routes>
        <Route exact path="TextUtilsReact/" element={<TextForm showAlert={showAlert} heading="Enter the text here to analyze" mode={mode}/>} />
        <Route exact path="TextUtilsReact/about" element={<About mode={mode}/>} />
      </Routes>
